package be.fgov.famhp.autocontrol.pharmacy.proxy.security.oauth2;

import be.fgov.famhp.autocontrol.pharmacy.proxy.security.oauth2.OAuthIdpTokenResponseDTO;
import java.net.URI;
